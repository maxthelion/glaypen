...
var EuclidianStepGenerator = /** @class */ (function (_super) {
    ...
    EuclidianStepGenerator.prototype.stepProbability = function (step) {
        var stepsInBar = 16;
        var generatorParams = this.grooveBox.generatorManager.currentGeneratorParams;
        var probability = this.euclidianRhythm(generatorParams.stepPulseNumber, stepsInBar)[step];
